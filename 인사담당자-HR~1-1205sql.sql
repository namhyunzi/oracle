...
CREATE TABLE sample_books (
    ...
    booke_price     NUMBER(7, 0) NOT NULL,
...
/*
    ...
    VALUES             (값,      값,      값),
    * 신규 행을 추가할 때 값이 저장된 컬럼을 직접 나열하는 방식이다.
...
INSERT INTO SAMPLE_BOOKS
VALUES(15, '모두의 네트워크', '미즈구치 카츠야', 14580, 5, SYSDATE);
...
-- 도서테이블에 대한 수정 사항이 데이터베이스에 영구적으로 반영된다.
COMMIT;
...
-- 도서테이블에서 책번호가 10번인 책정보(행)을 삭제하기
